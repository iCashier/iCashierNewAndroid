...
public class CartItemExtrasAdapter extends RecyclerView.Adapter<CartItemExtrasAdapter.ViewHolder>{

    Context context;
    List<CartItemModel.ExtrasBean> list;
    LayoutInflater inflater;
    String type="";
    public CartItemExtrasAdapter(Context context, List<CartItemModel.ExtrasBean> list,
                                 String type){
        this.list=list;
