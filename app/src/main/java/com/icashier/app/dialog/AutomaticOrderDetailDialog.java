...
public class AutomaticOrderDetailDialog extends Dialog implements ReceiveListener {
    ...
    public AutomaticOrderDetailDialog(HomeActivity context, OrderListResponse.ResultBean orderData, int pos) {
        super(context);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.flReceipt.setOnClickListener(V -> {
            new PaymentReceiptDialog(context, orderData.getPdf(), new PaymentReceiptDialog.PrintReceipt() {
                @Override
                public void onPrint() {
